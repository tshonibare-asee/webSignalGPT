...
class LaunchScreen {
    constructor() {
        ...
        let linkedinButton = document.querySelector('.intro__share-link--linkedin');
    ...
    skipClick(event) {
        ...
        const offset = intro.offsetHeight;

        if (GLOBALS.wizard && typeof GLOBALS.wizard.skip === 'function') {
            GLOBALS.wizard.skip();
        }
        ...
        TweenMax.to(intro, 0.5, {
            ...
            this.destroy();
            if (!GLOBALS.browserUtils.isMobile &&
                GLOBALS.wizard && typeof GLOBALS.wizard.startCamera === 'function') {
    ...
    startClick() {
        ...
        if (GLOBALS.browserUtils.isMobile || GLOBALS.browserUtils.isSafari) {
            GLOBALS.inputSection.createCamInput();
            GLOBALS.camInput.start();
            if (GLOBALS.wizard && typeof GLOBALS.wizard.touchPlay === 'function') {
        ...
        TweenMax.to(intro, 0.5, {
            ...
            onComplete: () => {
                this.destroy();
                if (GLOBALS.wizard && typeof GLOBALS.wizard.start === 'function') {
